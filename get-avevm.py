...
#                                                                              #
# Name: get-avevm.py                                                           #
# Purpose: Script to get Cisco AVE VM information                              #
#                                                                              #
################################################################################
...
if __name__ == "__main__":
    ...
    help_example = "Example usage: python get-avevm.py --vcenter 172.31.100.10 --vc-username 'administrator@vsphere.local'" \
    ...
    parser.add_argument( "--vc-password", "--vcPwd", type =str, help='vCenter user password' , required=False)
    args = parser.parse_args()
    import pdb
    pdb.set_trace()
    vtool = AciVTool(args.silent)
    vtool.vmware_set_auth(args.vcenter, args.vc_username, args.vc_password)
    vtool.ave_get(output='print')
